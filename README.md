<!-- mcp-name: CSOAI-ORG/performance-ai-mcp -->
[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/performance-ai-mcp.html)
...
[![PyPI](https://img.shields.io/badge/PyPI-Install-3775a9)](https://pypi.org/project/performance_ai_mcp/)
...
- [Full Documentation](https://docs.meok.ai/performance-ai-mcp)
...
- "Use `analyze_waterfall_data` to …"
- "Use `suggest_optimizations` to …"
- "Use `calculate_core_web_vitals` to …"
